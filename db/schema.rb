...
ActiveRecord::Schema.define(version: 20140614154200) do
  ...
  create_table "users", force: true do |t|
    ...
    t.string   "major"
    t.string   "other_acceptances"
    t.string   "other_waitlists"
    t.string   "applied_early"
    t.integer  "SAT_total"
    t.integer  "SAT_math"
    ...
    t.string   "class_rank"
    t.string   "main_high_school_awards"
    t.string   "main_extracurricular_activities"
    t.string   "job_experience"
    t.string   "volunteer_experience"
    t.string   "summer_activities"
    t.string   "my_strengths"
